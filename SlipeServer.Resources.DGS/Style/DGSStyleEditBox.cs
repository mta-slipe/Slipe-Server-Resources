...
public class DGSStyleEditBox
{
    ...
    // Selected background color when blurred
    ...
    public float CaretStyle { get; set; } = 0;
    ...
    public override string ToString()
    {
        ...
        sb.Write(nameof(MaskText), MaskText);
        ...
        sb.Write(nameof(TypingSoundVolume), TypingSoundVolume);
